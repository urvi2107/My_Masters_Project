...
def main():
    ...
    start_epoch = 0
    if not args.scratch:
        checkpoints = [f for f in os.listdir(checkpoint_dir) if f.startswith("best_model_tfno_epoch") and f.endswith(".pt")]
        if checkpoints:
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if (epoch + 1) % 5 == 0 or epoch == 0:
            ...
            if avg_vrmse < best_vrmse:
                ...
                checkpoint_name = f"best_model_tfno_epoch{epoch+1}_vrmse{best_vrmse:.4f}.pt"
