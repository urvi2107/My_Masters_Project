...
def main():
        ...
        for batch in tqdm(loader):
            ...
            if not example_logged:
                ...
                try:
                    ...
                    print("Generating FNO rollout video example...")
                    ...
                    video_path = os.path.join(video_out_dir, dataset.metadata.dataset_name, "rollout_video", f"epochfno_{dataset.metadata.dataset_name}.mp4")
    ...
    np.save("results/fno_vrmse.npy", avg_per_step_vrmse_fields)
    np.save("results/fno_nrmse_spectral.npy", nrmse_spectral)
    wandb.finish()
